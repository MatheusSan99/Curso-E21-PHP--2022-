...
: FUNÇÃO : DESCRIÇÃO : AVG : Retorna o valor médio do grupo : MIN : Retorna o valor mínimo do grupo : MAX : Retorna o valor máximo do grupo : SUM : Retorna a soma : COUNT : Retorna o numero de linhas da tabela
